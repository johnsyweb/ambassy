...
export function persistRegionalAmbassadors(
 ...
 */
function migrateEventAmbassadorData(
  eventAmbassadors: EventAmbassadorMap,
): EventAmbassadorMap {
 ...
 */
function migrateRegionalAmbassadorData(
  regionalAmbassadors: RegionalAmbassadorMap,
...
export function restoreApplicationState(): ApplicationState | null {
  ...
  const eventAmbassadorsMap = migrateEventAmbassadorData(
    new Map(eventAmbassadorsRaw),
  );
  const regionalAmbassadorsMap = migrateRegionalAmbassadorData(
    new Map(regionalAmbassadorsRaw),
  );
