...
describe("suggestReallocation", () => {
  ...
  describe("calculateGeographicProximityScore", () => {
    it("should return higher score for closer events", () => {
      ...
      const scoreClose = calculateGeographicProximityScore(
        recipientEvents,
        reallocatingEvents,
        eventDetails,
      );
      ...
      const scoreFar = calculateGeographicProximityScore(
        recipientEvents,
        reallocatingEventsFar,
        eventDetails,
      );
    ...
    it("should return 0 when recipient has no existing events", () => {
      ...
      const score = calculateGeographicProximityScore(
        recipientEvents,
        reallocatingEvents,
        eventDetails,
      );
    ...
    it("should give higher score for recipients with more available capacity", () => {
      ...
      const recipient2: EventAmbassador = {
        ...
        events: [
          ...
          "Event7",
          "Event8",
        ], // 8 events, can take 1 more
        capacityStatus: undefined,
      };

      const items = ["Event9"];
      const regionalAmbassadors: RegionalAmbassadorMap = new Map();
      const score1 = calculateReallocationScore(
        recipient1,
        "EA1",
        items,
        "events",
      ...
      const score2 = calculateReallocationScore(
        recipient2,
        "EA2",
        items,
        "events",
