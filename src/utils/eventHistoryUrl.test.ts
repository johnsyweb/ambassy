...
describe("buildEventHistoryUrl", () => {
  ...
  describe("with valid inputs", () => {
    it("should construct URL for Australian event", () => {
      ...
      expect(url).toBe(
        "https://www.parkrun.com.au/albertmelbourne/results/eventhistory/",
      );
    });
  ...
  describe("with different country codes", () => {
    it("should handle country code as string key lookup", () => {
      ...
      expect(url).toBe(
        "https://www.parkrun.com.au/testevent/results/eventhistory/",
      );
    });
    ...
    it("should work with single digit country codes", () => {
      ...
      expect(url).toBe(
        "https://www.parkrun.co.uk/testevent/results/eventhistory/",
      );
    });
  });
