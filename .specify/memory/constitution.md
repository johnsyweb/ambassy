...
2. Run `mise run lint` to verify all linting passes (zero errors, zero warnings)
...
6. Run `mise run test` to verify all tests pass
...
2. Verify the build completes successfully (`mise run build` or `./script/build`)
